Pod::Spec.new do |s|
  ...
  s.documentation_url = "https://docs.sixty.no/docs/ios-sdk/2.5.0/"
  ...
  s.source       = { :http => "https://sixty.bintray.com/cocoapods/ease-live-bridge-ios/2.5.0/EaseLiveiOSSDK-2.5.0.tar.gz" }
