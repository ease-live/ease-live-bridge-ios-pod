Pod::Spec.new do |s|
  ...
  s.documentation_url = "https://docs.easelive.tv/ios-sdk/2.10.1/"
  ...
  s.source       = { :http => "https://ease-live-sdk-releases.s3.eu-central-1.amazonaws.com/cocoapods/easelivesdk/2.10.1/EaseLiveiOSSDK-2.10.1.tar.gz" }
