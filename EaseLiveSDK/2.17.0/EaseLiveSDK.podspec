Pod::Spec.new do |s|
  ...
  s.documentation_url = "https://docs.easelive.tv/ios-sdk/2.17.0/"
  ...
  s.source       = { :http => "https://ease-live-sdk-releases.s3.eu-central-1.amazonaws.com/cocoapods/easelivesdk/2.17.0/EaseLiveiOSSDK-2.17.0.tar.gz" }
